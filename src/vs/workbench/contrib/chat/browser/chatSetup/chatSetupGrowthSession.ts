...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try KeepCode AI"),
			description: localize('growthSession.description', "KeepCode AI is available. Try it for free."),
