...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.104.0-dev',
			nameShort: 'KeepCode AI Dev',
			nameLong: 'KeepCode AI Dev',
			applicationName: 'keepcode-ai',
			dataFolderName: '.keepcode-ai',
			urlProtocol: 'keepcode-ai',
			reportIssueUrl: 'https://github.com/microsoft/vscode/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/microsoft/vscode/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/microsoft/vscode/blob/main/LICENSE.txt',
			defaultChatAgent: {
				extensionId: 'KeepCode.copilot',
				chatExtensionId: 'KeepCode.copilot-chat',
				provider: {
					default: {
						id: 'keepcodeai',
						name: 'KeepCode AI',
					...
					enterprise: {
						id: 'keepcodeai-enterprise',
						name: 'KeepCode AI Enterprise',
					}
				},
				providerScopes: []
			}
